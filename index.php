              ...
              <select class="form-select shadow-none" name="adult">
                <?php 
                  $guests_q = mysqli_query($con,"SELECT MAX(adult) AS `max_adult`, MAX(children) AS `max_children` 
                    FROM `venues` WHERE `status`='1' AND `removed`='0'");  
      ...
      <form action="venues.php">
        <div class="row align-items-end">
          <div class="col-lg-3 mb-3">
            ...
            <input type="date" name="booking_date" class="form-control shadow-none" value=<?php echo date('Y-m-d'); ?>>
          </div>
          <div class="col-lg-2 mb-3">
          ...
          <div class="col-lg-2 mb-3">
            <label class="form-label" style=font-weight: 500;">Price Per Event</label>
  ...
  <div class="container">
    <div class="row">
      ...
      <?php 
        ...
        $venue_res = select("SELECT * FROM `venues` WHERE `status`=? AND `removed`=? ORDER BY `id` DESC LIMIT 3",[1,0],'ii');
        ...
        while($venue_data = mysqli_fetch_assoc($venue_res))
        {
          ...
          if(!$settings_r['shutdown']){
            ...
            $book_btn = "<button onclick='checkLoginToBook($login,$venue_data[id])' class='btn btn-sm text-white custom-bg shadow-none'>Book Now</button>";
          }
          ...
          echo <<<data
            <div class="col-lg-4 col-md-6 my-3">
              <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                <img src="$venue_thumb" class="card-img-top">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-evenly mb-2">
                    $book_btn
                    <a href="venue_details.php?id=$venue_data[id]" class="btn btn-sm btn-outline-dark shadow-none">More details</a>
                  </div>
                </div>
              </div>
            </div>
