...
<head>
  ...
  <title><?php echo $settings_r['site_title'] ?> - venues</title>
</head>
<body class="bg-light">
  ...
  <?php 
    ...
    if(isset($_GET['booking_date']))
    {
      ...
      $checkin_default = $frm_data['booking_date'];
      // $checkout_default = $frm_data['checkout'];
      $adult_default = $frm_data['price'];
      $children_default = $frm_data['capacity'];

    }
  ?>

  <div class="my-5 px-4">
    <h2 class="fw-bold h-font text-center">OUR VENUES</h2>
  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white rounded shadow">
          <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
              <!-- Check availablity -->
              <div style="display: none" class="border bg-light p-3 rounded mb-3">
              ...
              <div class="border bg-light p-3 rounded mb-3">
                ...
                <?php 
                  ...
                  while($row = mysqli_fetch_assoc($facilities_q))
                  {
                    echo<<<facilities
                      <div class="mb-2">
                        <input type="checkbox" onclick="fetch_venues()" name="facilities" value="$row[id]" class="form-check-input shadow-none me-1" id="$row[id]">
      ...
      <div class="col-lg-9 col-md-12 px-4" id="venues-data">
      </div>
  ...
  <script>
    ...
    let venues_data = document.getElementById('venues-data');
    ...
    function fetch_venues()
    {
      ...
      xhr.open("GET","ajax/venues.php?fetch_venues&chk_avail="+chk_avail+"&guests="+guests+"&facility_list="+facility_list,true);

      xhr.onprogress = function(){
        venues_data.innerHTML = `<div class="spinner-border text-info mb-3 d-block mx-auto" id="loader" role="status">
          <span class="visually-hidden">Loading...</span>
        </div>`;
      }

      xhr.onload = function(){
        venues_data.innerHTML = this.responseText;
      }
