...
<body class="bg-light">
          ...
          if($data['booking_status']=='booked')
          {
            ...
            if($data['arrival']==1)
            {
              ...
              if($data['rate_review']==0){
                $btn.="<button type='button' onclick='review_venue($data[booking_id],$data[venue_id])' data-bs-toggle='modal' data-bs-target='#reviewModal' class='btn btn-dark btn-sm shadow-none ms-2'>Rate & Review</button>";
              }
            }
            else{
          ...
          echo<<<bookings
            <div class='col-md-4 px-4 mb-4'>
              <div class='bg-white p-3 rounded shadow-sm'>
                <h5 class='fw-bold'>$data[venue_name]</h5>
                <p>Rs.$data[price] per event</p>
                <!--<p>
  ...
  <script>
    ...
    function review_venue(bid,rid){
      review_form.elements['booking_id'].value = bid;
      review_form.elements['venue_id'].value = rid;
    }
    ...
    review_form.addEventListener('submit',function(e){
      ...
      data.append('venue_id',review_form.elements['venue_id'].value);

      let xhr = new XMLHttpRequest();
      xhr.open("POST","ajax/review_venue.php",true);
